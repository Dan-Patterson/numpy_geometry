...
# import npgDocs
from npgDocs import Geo_hlp  # dirr_doc), npGeo_doc, sort_by_extent_doc
...
__all__ = [
    'Geo', 'array_IFT', 'arrays_to_Geo', 'Geo_to_arrays',
...
class Geo(np.ndarray):
    ...
    def bits(self):
        ...
        """
        return np.asarray([np.array(self[f:t]) for f, t in self.FT])
